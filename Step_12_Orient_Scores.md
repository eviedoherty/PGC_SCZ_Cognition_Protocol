...
data_complete_cases_clean$log_processing_speed_oriented <- -data_complete_cases_clean$log_processing_speed #adjust to match dataframe and cognitive measure column name
```
