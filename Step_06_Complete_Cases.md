```{r}
#STEP 6 - GET THE COMPLETE CASES NUMBER AND THE EXACT MEASURES/DOMAINS MAXIMISING THE SAMPLE
#THIS CODE PRODUCES THE NUMBER OF COMPLETE CASES IF A MINIMUM OF N DOMAINS WERE APPLIED I.E. WILL TELL YOU THE NUMBER OF COMPLETE CASES IF 2/3/4/5/6 DOMAINS WERE USED - HELPS THE DECISION MAKING PROCESS ON THE NUMBER OF MEASURES/DOMAINS CAN BE INCLUDED WHILE STILL MAXIMISING THE SAMPLE - SEE PHENOTYPE PROTOCOL 
```
