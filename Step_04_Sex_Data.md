...
sum(!is.na(data_cases_filtered_age$sex_colname)) #adjust to match sex column name in your dataset 
data_cases_filtered_age

table(data_cases_filtered_age$sex_colname) #adjust to match sex column name in your dataset 
```
