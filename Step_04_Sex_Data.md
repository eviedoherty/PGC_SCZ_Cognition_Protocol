...
sum(!is.na(data_cases_filtered_age$sex_colname)) #add the sex column name from your dataset
data_cases_filtered_age

table(data_cases_filtered_age$sex_colname) #add the sex column name from your dataset
```
